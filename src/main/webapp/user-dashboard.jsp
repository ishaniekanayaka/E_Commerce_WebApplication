...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-text">Easily add, view, or manage Users for your e-commerce platform. Stay organized and up-to-date!</p>

            <!-- Buttons to Add and View Categories -->
          <%--  <div class="d-flex justify-content-center">
                ...
                <form action="user-list.jsp" class="me-3">
                    <button type="submit" class="btn btn-danger">View Users</button>
                </form>
            ...
            <div class="d-flex justify-content-center mb-4">
                <form action="user-list" class="me-3">
                    <button type="submit" class="btn btn-danger">View Users</button>
                </form>
                <form action="admin-register.jsp">
